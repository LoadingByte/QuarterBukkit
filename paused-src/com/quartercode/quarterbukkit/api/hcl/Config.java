...
public class Config implements ParentEntry {
     ...
     */
    public ConfigEntry getChild(final String path) {

        if (path.contains("\\.")) {
            final String[] names = path.split("\\.");
            ParentEntry currentEntry = this;
            for (final String name : names) {
                final ConfigEntry configEntry = getChild(currentEntry, name);
     ...
     */
    public ConfigEntry getChild(final ParentEntry parentEntry, final String name) {
    ...
    public int hashCode() {
        ...
        result = prime * result + ( (firstLevelConfigEntries == null) ? 0 : firstLevelConfigEntries.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (customTypes == null) {
            if (other.customTypes != null)
                return false;
        } else if (!customTypes.equals(other.customTypes))
            return false;
        if (firstLevelConfigEntries == null) {
            if (other.firstLevelConfigEntries != null)
                return false;
        } else if (!firstLevelConfigEntries.equals(other.firstLevelConfigEntries))
            return false;
        if (parser == null) {
    ...
    public String toString() {
        ...
        return getClass().getName() + " [plugin=" + plugin + ", parser=" + parser + ", customTypes=" + customTypes + ", firstLevelConfigEntries=" + firstLevelConfigEntries + "]";
    }
