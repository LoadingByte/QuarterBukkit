 ...
 */
public class QuarterBukkitException extends Exception {
     ...
     */
    public QuarterBukkitException(final Plugin plugin) {
     ...
     */
    public QuarterBukkitException(final Plugin plugin, final String message) {
